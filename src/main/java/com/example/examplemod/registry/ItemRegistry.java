...
public final class ItemRegistry {
	...
	public static final DeferredHolder<Item, BlockItem> GECKO_HABITAT = ITEMS.register("gecko_habitat", () -> new GeckoHabitatItem(BlockRegistry.GECKO_HABITAT.get(), new Item.Properties()));
	public static final DeferredHolder<Item, BlockItem> FERTILIZER = ITEMS.register("fertilizer", () -> new BlockItem(BlockRegistry.FERTILIZER.get(), new Item.Properties()));
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLEMOD_TAB = TABS.register("examplemod_items", () -> CreativeModeTab.builder()
			.title(Component.translatable("itemGroup." + ExampleMod.MODID + ".examplemod_items"))
