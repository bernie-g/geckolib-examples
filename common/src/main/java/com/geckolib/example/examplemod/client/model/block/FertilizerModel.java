...
public class FertilizerModel extends DefaultedBlockGeoModel<FertilizerBlockEntity> {
	private final Identifier BOTARIUM_MODEL = buildFormattedModelPath(Identifier.fromNamespaceAndPath(ModConstants.MODID, "botarium"));
	private final Identifier BOTARIUM_TEXTURE = buildFormattedTexturePath(Identifier.fromNamespaceAndPath(ModConstants.MODID, "botarium"));
	private final Identifier BOTARIUM_ANIMATIONS = buildFormattedAnimationPath(Identifier.fromNamespaceAndPath(ModConstants.MODID, "botarium"));

	public FertilizerModel() {
		super(Identifier.fromNamespaceAndPath(ModConstants.MODID, "fertilizer"));
	}
