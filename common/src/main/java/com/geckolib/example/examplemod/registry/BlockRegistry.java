...
import com.geckolib.example.examplemod.block.FertilizerBlock;
import com.geckolib.example.examplemod.block.GeckoHabitatBlock;
...
public final class BlockRegistry {
	...
	private static <T extends Block> Supplier<T> registerBlock(String id, Function<BlockBehaviour.Properties, T> block) {
		return ModConstants.PLATFORM.registerBlock(id, block);
	}
}
