 ...
 * @see com.geckolib.example.examplemod.client.renderer.entity.BikeRenderer BikeRenderer
 * @see com.geckolib.example.examplemod.client.model.entity.BikeModel BikeModel
 */
