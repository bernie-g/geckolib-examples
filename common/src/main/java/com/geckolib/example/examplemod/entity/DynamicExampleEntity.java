 ...
 *
 * @see com.geckolib.example.examplemod.client.renderer.entity.MutantZombieRenderer MutantZombieRenderer
...
public class DynamicExampleEntity extends PathfinderMob implements GeoEntity {
	...
	protected InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (player instanceof ServerPlayer serverPlayer)
			serverPlayer.sendSystemMessage(Component.translatable("entity." + ModConstants.MODID + ".mutant_zombie.equip", stack.getDisplayName()));
