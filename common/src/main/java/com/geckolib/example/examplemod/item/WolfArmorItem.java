...
import com.geckolib.example.examplemod.client.renderer.armor.WolfArmorRenderer;
...
public final class WolfArmorItem extends Item implements GeoItem {
	...
	public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
		consumer.accept(new GeoRenderProvider() {
			...
			private final Supplier<WolfArmorRenderer<?>> renderer = Suppliers.memoize(WolfArmorRenderer::new);
